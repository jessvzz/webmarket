...
public class SecurityHelpers {
    ...
    switch (tipo) {
        ...
        case "TECNICO":
            return requestedPage.contains("tecnico") || requestedPage.contains("/invioproposta")|| requestedPage.contains("/richiesta_inattesa") || requestedPage.contains("/cambio_password");
        case "ORDINANTE":
